...
import { useWhyDidYouRender } from '../src/use-why-did-you-render';
import type { WhyDidYouRenderOptions } from '../src/types';
...
function ProbeWithOptions({ options, ...rest }: Record<string, unknown> & { options?: WhyDidYouRenderOptions }) {
...
describe('useWhyDidYouRender', () => {
	...
	it('honors a custom equality function', () => {
		...
		const { rerender } = render(<ProbeWithOptions options={options} user={{ id: 1 }} />);

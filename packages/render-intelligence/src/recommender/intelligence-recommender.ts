			...
			.map((c) => {
				...
				return {
					...
					evidence: Object.freeze([
						{ type: 'component-analysis', componentName: c.componentName, avgScore: c.averageScore, grade: c.grade },
					] as IntelligenceRecommendationEvidence[]),
				};
			}),
};
...
const ACTIONABLE_RULES: RecommendationRule[] = [
	rFUNC001, rOBJ001, rARR001, rMEMO001, rMEMO002,
	rFREQ001, rPARENT001, rTREND001,
	rSYNC001, rCASC001,
	rAPP001, rAPP002, rCOV001,
];

...
export const metadata: Metadata = {
	...
	description:
		'React Render Observability SDK. 12 dev-only packages for tracing renders, detecting prop instability, time-travel replay, and static analysis. Zero production cost.',
	keywords: [
		'react',
		'render',
		'debugging',
	...
	openGraph: {
		...
		description:
			'12 dev-only packages for tracing renders, detecting prop instability, time-travel replay, and static analysis.',
...
const RootLayout = ({ children }: Props) => (
	<html lang="en" className={geistMono.variable}>
		<body className="bg-canvas text-ink font-mono min-h-screen antialiased leading-relaxed">
			<header
				className="sticky top-0 z-10 flex items-center justify-between border-b border-edge bg-canvas"
				style={{ height: 52, padding: '0 24px' }}
			>
				{/* Logo */}
				<Link
					href="/"
					className="flex items-center gap-2 text-ink font-semibold text-sm tracking-tight no-underline hover:no-underline"
